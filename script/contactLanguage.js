const handleContactLanguage = () => {
  ...
  formAlert.textContent = contactContent.form.alert[language]

  // placeholders:
  formNamePlaceholder.placeholder = contactContent.form.name.placeholder[language]
  formEmailPlaceholder.placeholder = contactContent.form.email[language]
  formCompanyPlaceholder.placeholder = contactContent.form.company.placeholder[language]
  formMessagePlaceholder.placeholder = contactContent.form.message.placeholder[language]
